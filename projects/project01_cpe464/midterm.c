...
/* 24 bytes (192 bits) */
typedef struct pcap_header {    /* Offset */
    uint32_t magic;             /*      0 */
...
/* 16 bytes (128 bits) */
typedef struct packet_header {  /* Offset */
    uint32_t t_sec;             /*      0 */
    uint32_t t_usec;            /*     32 */
    uint32_t cap_len;           /*     64 */
    uint32_t org_len;           /*     96 */
...
/* 14 bytes (112 bits) */
typedef struct eth_header {     /* Offset */
...
/* 28 bytes (224 bits) */
typedef struct arp_header {     /* Offset */
    uint16_t H_TYPE;            /*      0 */
    uint16_t P_TYPE;            /*     16 */
    uint8_t H_LEN;              /*     32 */
    uint8_t P_LEN;              /*     40 */
...
/* 20 bytes (160 bits) */
typedef struct ip_v4_header {   /* Offset */
    uint8_t Ver_IHL;            /*    0/4 */
    uint8_t TOS;                /*      8 */
    uint16_t len;               /*     16 */
    uint16_t ID;                /*     32 */
...
/* 16 bytes (128 bits) */
typedef struct ip_v6_header {   /* Offset */
    uint8_t version: 4;         /*      0 */
    uint8_t traffic_class;      /*      4 */
    uint32_t flow_label: 20;    /*     12 */
    uint16_t payload_len;       /*     32 */
    uint8_t next_header;        /*     48 */
    uint8_t hop_limit;          /*     56 */
    uint32_t src_addr;          /*     64 */
    uint32_t dst_addr;          /*     96 */
} ip_v6_header_t;

/* 20 bytes (160 bits) */
typedef struct tcp_header {     /* Offset */
    uint16_t src_port;          /*      0 */
...
/* 12 bytes (96 bits) */
typedef struct pseudo_header {  /* Offset */
    uint32_t src_addr;          /*      0 */
...
/* 4 bytes (32 bits) */
typedef struct icmp_header {    /* Offset */
    uint8_t type;               /*      0 */
    uint8_t code;               /*      8 */
    uint16_t cksum;             /*     16 */
    uint32_t data;              /*     32 */
...
/* 8 bytes (64 bits) */
typedef struct udp_header {     /* Offset */
    uint16_t src_port;          /*      0 */
    uint16_t dst_port;          /*     16 */
    uint16_t udp_len;           /*     32 */
    uint16_t cksum;             /*     48 */
